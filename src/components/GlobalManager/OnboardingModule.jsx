                  ...
                  <div className="gmon-contractModal">
                    ...
                    <div className="gmon-contractDoc">
                      ...
                      <section>
                        ...
                        <p>
                          Cuando Volta entregue o habilite una Ruta de Acceso StoreGate, dicha entrega consistira en
                          facilitar al Comerciante un acceso operativo al motor de ventas dentro de la Plataforma. Salvo
                          pacto escrito especifico, esta entrega no implica que Volta deba integrar, instalar, insertar
                          o conectar botones, enlaces, iframes, scripts u otros elementos en paginas web, redes sociales,
                          aplicaciones, perfiles, marketplaces o canales digitales del Comerciante o de terceros.
                        </p>
                        <p>
                      ...
                      <section>
                        ...
                        <p>
                          El Comerciante sera responsable de difundir, publicar y mantener visible la Ruta de Acceso
                          StoreGate en sus canales propios o autorizados, incluyendo su pagina web, redes sociales,
                          perfiles digitales, codigos QR, materiales comerciales o comunicaciones con clientes, cuando
                          desee dirigir trafico al motor de ventas habilitado por Volta. La falta de difusion por parte
                          del Comerciante no constituira incumplimiento de Volta ni generara derecho a reclamar volumen
                      ...
                      <section>
                        ...
                        <p>
                          Respecto de la Ruta de Acceso StoreGate, la obligacion de Volta se limitara a habilitar o
                          comunicar al Comerciante una ruta funcional de acceso a la Plataforma, salvo que las partes
                          acuerden expresamente por escrito servicios adicionales de integracion, desarrollo, publicacion,
                          marketing o gestion de canales externos.
                        </p>
                      </section>
